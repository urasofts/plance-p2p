document.addEventListener('DOMContentLoaded', () => {
        ...
        steps: [
            {
                ...
                popover: {
                    ...
                    description: 'Este selector muestra el canal disponible para esta categoría. En este caso verás un flujo con API Link de pagos, ideal para compartir un enlace de cobro al cliente.'
                }
            },
            {
                ...
                popover: {
                    ...
                    description: 'Esta etiqueta indica que el cobro se hace por medio de un link. El comercio genera el enlace y el cliente lo abre para completar el pago de forma segura con PlacetoPay.'
                }
            },
            {
                element: '#tarjeta',
                popover: {
                    title: 'Selecciona un equipo para comprar',
                    description: 'Cada tarjeta representa una equipación que el cliente puede adquirir. Al entrar en Productos verás el ejemplo completo del flujo de compra con enlace de pago.',
                    onNextClick: () => {
                        localStorage.setItem('tutorial', 'pendiente');
                        driver.destroy();
    ...
    iniciarTutorialButton.addEventListener('click', iniciarTourTextiles);
