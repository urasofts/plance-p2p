...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .order-details{background:var(--pt-bg-card);/* border:1px solid var(--pt-border) */;border-radius:10px;padding:1rem 1.2rem;margin-bottom:1rem;text-align:left;}
        ...
        .token-box{background:rgba(34,197,94,0.08);border:1px solid rgba(34,197,94,0.2);border-radius:8px;padding:0.75rem 1rem;margin-bottom:1.2rem;text-align:left;font-size:0.82rem;color:#86efac;display:flex;gap:0.5rem;align-items:flex-start;}
