...
<style>
    /* EA Sports FC — acento verde */
    :root {
        --gj-accent:        #00ff6a;
        --gj-accent-glow:   rgba(0, 255, 106, 0.25);
        --gj-accent-soft:   rgba(0, 255, 106, 0.15);
        --gj-accent-hover:  rgba(0, 255, 106, 0.4);
        --gj-accent-dark:   #00af43;
    }
</style>
<body>
      <?php
  ...
  <span class="jk">"payment"</span>: {
    <span class="jk">"reference"</span>: <span class="js">"ORD-000317"</span>,
    <span class="jk">"description"</span>: <span class="js">"500 FC"</span>,
    <span class="jk">"amount"</span>: { <span class="jk">"currency"</span>: <span class="js">"COP"</span>, <span class="jk">"total"</span>: <span class="jn">14000</span> }
  },
  <span class="jk">"expiration"</span>: <span class="js">"2026-08-25T11:15:32-05:00"</span>,
  <span class="jk">"returnUrl"</span>: <span class="js">"https://tu-dominio.com/retorno/retorno.php?order=317"</span>,
...
<span class="cvar">$data</span> = [
    ...
    <span class="jk">'payment'</span> =&gt; [
        ...
        <span class="jk">'description'</span> =&gt; <span class="cvar">$producto</span>,               <span class="cm">// ej: "500 FC"</span>
...
header(<span class="js">'Location: '</span> . <span class="cvar">$result</span>[<span class="js">'processUrl'</span>]);</code></pre>
    ...
    <div class="doc-note">
      ...
      <span>Este flujo es <strong>Web Checkout de pago único</strong>: un solo cobro por el valor de los FC elegidos, sin tokenizar tarjeta ni programar cobros futuros. Cuando vuelvas de la pasarela, consultamos el estado real de la sesión antes de entregar los puntos.</span>
    </div>
