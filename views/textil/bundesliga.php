...
<style>
    /* Bundesliga — acento rojo */
    :root {
        --tex-accent:      #dc2626;
        --tex-accent-rgb:  220, 38, 38;
        --tex-accent-dark: #b91c1c;
    }
</style>
<body>
    <?php
    ...
    <div class="game-banner">
        <div class="game-banner__tag">
            <i class="fa-solid fa-futbol" style="color: hsl(0, 74%, 51%);"></i> Bundesliga — Kits Deportivos
    ...
    <main class="shop-layout">
        <section class="products-panel">
            ...
            <div class="products-grid">
                ...
                <div class="product-card" data-id="1" data-producto="Kit Bayern Munich" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=fcbayern.com&sz=128" alt="Bayern München">
                    </div>
                    <div class="product-card__name">Bayern München</div>
                    <div class="product-card__label">Camiseta · Temporada 24/25</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="2" data-producto="Kit Borussia Dortmund" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=bvb.de&sz=128" alt="Borussia Dortmund">
                    </div>
                    <div class="product-card__name">Borussia Dortmund</div>
                    <div class="product-card__label">Camiseta · Temporada 23/24</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="3" data-producto="Kit RB Leipzig" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=dierotenbullen.com&sz=128" alt="RB Leipzig">
                    </div>
                    <div class="product-card__name">RB Leipzig</div>
                    <div class="product-card__label">Camiseta · Temporada 22/23</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="4" data-producto="Kit Bayer 04 Leverkusen" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=bayer04.de&sz=128" alt="Bayer 04 Leverkusen">
                    </div>
                    <div class="product-card__name">Bayer 04 Leverkusen</div>
                    <div class="product-card__label">Camiseta · Temporada 21/22</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="5" data-producto="Kit Eintracht Frankfurt" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=eintracht.de&sz=128" alt="Eintracht Frankfurt">
                    </div>
                    <div class="product-card__name">Eintracht Frankfurt</div>
                    <div class="product-card__label">Camiseta · Temporada 24/25</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="6" data-producto="Kit VfB Stuttgart" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=vfb.de&sz=128" alt="VfB Stuttgart">
                    </div>
                    <div class="product-card__name">VfB Stuttgart</div>
                    <div class="product-card__label">Camiseta · Temporada 23/24</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="7" data-producto="Kit Borussia Monchengladbach" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=borussia.de&sz=128" alt="Borussia Mönchengladbach">
                    </div>
                    <div class="product-card__name">B. Mönchengladbach</div>
                    <div class="product-card__label">Camiseta · Temporada 20/21</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="8" data-producto="Kit Werder Bremen" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=werder.de&sz=128" alt="Werder Bremen">
                    </div>
                    <div class="product-card__name">Werder Bremen</div>
                    <div class="product-card__label">Camiseta · Temporada 22/23</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>
            ...
            <div class="checkout-box">
                <div class="checkout-header">
                    ...
                    <div class="checkout-product-info">
                        <div class="checkout-product-name" id="checkoutName">Bayern München</div>
  ...
  <span class="jk">"name"</span>: <span class="js">"Kit Bayern Munich"</span>,
  <span class="jk">"description"</span>: <span class="js">"Kit deportivo: Kit Bayern Munich"</span>,
