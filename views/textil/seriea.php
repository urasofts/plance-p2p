...
<style>
    /* Serie A — acento verde azulado */
    :root {
        --tex-accent:      #0d9488;
        --tex-accent-rgb:  13, 148, 136;
        --tex-accent-dark: #0f766e;
    }
</style>
<body>
    <?php
    ...
    <div class="game-banner">
        <div class="game-banner__tag">
            <i class="fa-solid fa-futbol" style="color: hsl(175, 84%, 32%);"></i> Serie A — Kits Deportivos
    ...
    <main class="shop-layout">
        <section class="products-panel">
            ...
            <div class="products-grid">
                ...
                <div class="product-card" data-id="1" data-producto="Kit Juventus" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=juventus.com&sz=128" alt="Juventus">
                    </div>
                    <div class="product-card__name">Juventus</div>
                    <div class="product-card__label">Camiseta · Temporada 24/25</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="2" data-producto="Kit Inter de Milan" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=inter.it&sz=128" alt="Inter de Milán">
                    </div>
                    <div class="product-card__name">Inter de Milán</div>
                    <div class="product-card__label">Camiseta · Temporada 23/24</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="3" data-producto="Kit AC Milan" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=acmilan.com&sz=128" alt="AC Milan">
                    </div>
                    <div class="product-card__name">AC Milan</div>
                    <div class="product-card__label">Camiseta · Temporada 22/23</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="4" data-producto="Kit Napoli" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=sscnapoli.it&sz=128" alt="Napoli">
                    </div>
                ...
                <div class="product-card" data-id="5" data-producto="Kit AS Roma" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=asroma.com&sz=128" alt="AS Roma">
                    </div>
                    <div class="product-card__name">AS Roma</div>
                    <div class="product-card__label">Camiseta · Temporada 21/22</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="6" data-producto="Kit Lazio" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=sslazio.it&sz=128" alt="Lazio">
                    </div>
                    <div class="product-card__name">Lazio</div>
                    <div class="product-card__label">Camiseta · Temporada 20/21</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="7" data-producto="Kit Atalanta" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=atalanta.it&sz=128" alt="Atalanta">
                    </div>
                    <div class="product-card__name">Atalanta</div>
                    <div class="product-card__label">Camiseta · Temporada 23/24</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>

                <div class="product-card" data-id="8" data-producto="Kit Fiorentina" data-precio="50000">
                    <div class="product-card__img">
                        <img src="https://www.google.com/s2/favicons?domain=acffiorentina.com&sz=128" alt="Fiorentina">
                    </div>
                    <div class="product-card__name">Fiorentina</div>
                    <div class="product-card__label">Camiseta · Temporada 22/23</div>
                    <div class="product-card__price">50.000 COP</div>
                </div>
            ...
            <div class="checkout-box">
                <div class="checkout-header">
                    ...
                    <div class="checkout-product-info">
                        <div class="checkout-product-name" id="checkoutName">Juventus</div>
  ...
  <span class="jk">"name"</span>: <span class="js">"Kit Juventus"</span>,
  <span class="jk">"description"</span>: <span class="js">"Kit deportivo: Kit Juventus"</span>,
